...
var Test = function() {
	...
	var url='http://127.0.0.1:5000/api/perfil'
	...
	var fnSetUrlId=function(){
		print("SetUrlId");
		try{
			var reg=json.search('perfil', crud.getDataSearch());					
			urlById=url+'/'+reg["id_perfil"]+'?'+tokenParam
			console.log(urlById); 
			next();
		}catch (e) {
		   console.log(e); 
	...
	var fnUpdate=function(){
			...
			crud.setDataSearch(dataUpdate.perfil);
	...
	crud.setDataSearch(data.perfil);	

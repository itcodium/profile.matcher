...
app.controller("appController", function($scope,$http,$location) {
	...
	$scope.user={name:user.usuario,
				 imageProfile:"assets/images/avatar1.png",
				 userItems:[ {show:true,title:"Profile",ref:"profile.html",class:"fa fa-user",divider:""},
							 {show:false,title:"",ref:"",divider:"divider"},
							 {show:false,title:"Lock screen",ref:"lock-screen.html",class:"fa fa-lock",divider:""},
							 {show:true,title:"Log out",ref:"login.html",click:$scope.logOut, class:"fa fa-sign-out m-r-xs",divider:""}
				 		 ]
				}
